...
type JZYOutsideModule struct {
	cdm      *construct.Construct_JZY
	pbftNode *PbftConsensusNode
}

func (crom *JZYOutsideModule) HandleMessageOutsidePBFT(msgType message.MessageType, content []byte) bool {
	switch msgType {
	case message.CRelay:
...
func (crom *JZYOutsideModule) handleRelay(content []byte) {
...
// ok
func (crom *JZYOutsideModule) handleInjectTx(content []byte) {
...
func (crom *JZYOutsideModule) handlePartitionMsg(content []byte) {
...
func (crom *JZYOutsideModule) handlePartitionReady(content []byte) {
...
func (crom *JZYOutsideModule) handleAccountStateAndTxMsg(content []byte) {
